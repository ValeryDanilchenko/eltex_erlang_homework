...
ipv4(<<Version:4, IHL:4, ToS:8, TotalLength:16, Identification:16, Flags:3, FragOffset:13,
    ...
    when Version =:= 4 ->
        ...
        #ipv4{
            ...
            data = RemainingData};
ipv4(Data) ->
    io:format("Invalid data ~p ~n", [Data]),
    erlang:error({badmatch, Data}).
...
ipv4_listener()->
    receive
        ...
        _Msg ->
            io:format("Invalid message received: ~p ~n", [_Msg]),
            erlang:error(badarg)
    end.

% Data1 = << 4:4, 6:4, 0:8, 232:16, 0:16, 0:3, 0:13, 0:8, 0:8, 0:16, 0:32, 0:32, 0:32, "hello" >>.
% Data2 = << 4:4, 6:4, 0:8, 206:16, 0:16, 0:3, 0:13, 0:8, 0:8, 0:16, 0:32, 0:32, 0:32, "qwerty1234":14 >>.
